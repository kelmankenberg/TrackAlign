...
- App icon: Lucide `ListOrdered` in the custom titlebar and matching native window/taskbar asset.
...
- Appearance: provide persisted light and dark mode presets, including a VS Code Default Dark option, accessible from Settings and the More menu.
